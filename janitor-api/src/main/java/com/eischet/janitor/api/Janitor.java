...
public final class Janitor {
    ...
    /**
     * Returns a valid Janitor object for the nullable parameter, i.e. turns Java null into Janitor.NULL.
     *
     * @param object a JanitorObject or Java null.
     * @return a non-null JanitorObject, which might by Janitor.NULL
     */
    public static @NotNull JanitorObject nullableObject(@Nullable JanitorObject object) {
        return object == null ? Janitor.NULL : object;
    }
     ...
     */
    public static @NotNull JanitorObject nullableDateFromLiteral(@Nullable String text) throws JsonException {
