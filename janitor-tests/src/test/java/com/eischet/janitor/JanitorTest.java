...
public abstract class JanitorTest {
    ...
    protected JanitorObject evaluateWithConfigurableProcess(final @Language("Janitor") String expressionSource,
                                                            final @Nullable Consumer<JanitorScriptProcess> processConfigurer)
        ...
        try {
            ...
            processConfigurer.accept(process);
