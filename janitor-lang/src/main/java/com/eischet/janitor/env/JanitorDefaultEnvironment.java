...
public abstract class JanitorDefaultEnvironment implements JanitorEnvironment {
    ...
    public JanitorObject lookupClassAttribute(final @NotNull JanitorScriptProcess runningScript, final @NotNull JanitorObject instance, final @NotNull String attributeName) {
        if (instance instanceof JString str) {
            ...
            if (attr != null) {
                final JanitorObject lkup = attr.lookupAttribute(runningScript, (JDateTime) instance);
                if (lkup != null) {
                    return lkup;
                }
            }
            ...
            if (attr != null) {
                final JanitorObject lkup = attr.lookupAttribute(runningScript, list);
                if (lkup != null) {
                    return lkup;
                }
            }
            ...
            if (attr != null) {
                final JanitorObject lkup = attr.lookupAttribute(runningScript, set);
                if (lkup != null) {
                    return lkup;
                }
            }
            ...
            if (attr != null) {
                final JanitorObject lkup = attr.lookupAttribute(runningScript, map);
                if (lkup != null) {
                    return lkup;
                }
            }
            ...
            if (attr != null) {
                final JanitorObject lkup = attr.lookupAttribute(runningScript, integer);
                if (lkup != null) {
                    return lkup;
                }
            }
            ...
            if (attr != null) {
                final JanitorObject lkup = attr.lookupAttribute(runningScript, binary);
                if (lkup != null) {
                    return lkup;
                }
            }
        ...
        if (attributeBuilder != null) {
            return attributeBuilder.lookupAttribute(runningScript, instance);
        }
        return null;
    }
    ...
    public JanitorDefaultEnvironment(JanitorFormatting formatting) {
        ...
        addDateTimeAttribute("epoch", (runningScript, instance) -> JDateTimeClass.__epochAsAttribute(instance));
    ...
    public void addDateTimeMethod(final String name, final JUnboundMethod<JDateTime> method) {
        addDateTimeAttribute(name, (runningScript, instance) -> new JBoundMethod<>(name, instance, method));
    }
    ...
    public <T extends JanitorObject> void addGeneric(final String name, Class<T> cls, final AttributeLookupHandler<T> attributeBuilder) {
        anyAttributes.put(name, new AttributeLookupHandler<JanitorObject>() {
            @Override
            public JanitorObject lookupAttribute(final JanitorScriptProcess runningScript, final JanitorObject instance) {
                if (cls.isInstance(instance)) {
                    return attributeBuilder.lookupAttribute(runningScript, cls.cast(instance));
                } else {
                    return null;
                }
            }
    ...
    public void addListMethod(final String name, final JUnboundMethod<JList> method) {
        listAttributes.put(name, (runningScript, instance) -> new JBoundMethod<>(name, instance, method));
    }

    public void addSetMethod(final String name, final JUnboundMethod<JSet> method) {
        setAttributes.put(name, (runningScript, instance) -> new JBoundMethod<>(name, instance, method));
    }

    public void addMapMethod(final String name, final JUnboundMethod<JMap> method) {
        mapAttributes.put(name, (runningScript, instance) -> new JBoundMethod<>(name, instance, method));
    }

    public void addStringMethod(final String name, final JUnboundMethod<JString> method) {
        stringAttributes.put(name, (runningScript, instance) -> new JBoundMethod<>(name, instance, method));
    }
