package com.eischet.janitor.cleanup.repl;
...
import com.eischet.janitor.cleanup.compiler.JanitorAntlrCompiler;
...
public class JanitorRepl {
    ...
    public PartialParseResult parse(final String text) throws JanitorControlFlowException, JanitorRuntimeException {
        ...
        if (compiledText instanceof Statement compiledStatement) {
            ...
            final Script partialScript = new Script(loc, Lists.immutable.of(compiledStatement), text);
